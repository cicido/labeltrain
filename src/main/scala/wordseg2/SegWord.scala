...
object SegWord {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val nrPrefix = Config.nrPrefix
    val nrSuffix = Config.nrSuffix
    val nsStopWords = Config.nsStopWords
    val nrStopWords = Config.nsStopWords
    val otherStopWords = Config.otherStopWords
